...
print([str(x) for x in sorted(users, key=lambda obj: obj.name)])
print([str(x) for x in sorted(users, key=lambda obj: obj.number_of_logins)])
print([str(x) for x in sorted(users, key=lambda obj: obj.registered_on)])
print([str(x) for x in sorted(users, key=lambda obj: obj.last_seen)])